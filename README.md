...
```javascript
isBuffer = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-buffer@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/assert-is-buffer/tags). For example,

```javascript
isBuffer = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-buffer@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-buffer@umd/browser.js"></script>
```
